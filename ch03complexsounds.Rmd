...
- Next, in the `Praat` object window, choose `View & Edit`. This will open a so-called SoundEditor window, with the oscillogram as its main feature. For more details and instructions about the SoundEditor, see §\@ref(sec:praatsoundeditor) and Appendix \@ref(app:praat). 
