...
There are several ways to adjust the level of the recording: 
  ...
  - by adjusting the level of the input channel (perhaps called `Gain`), in your computer settings, 
...
There is a helpful option in `Praat`, from the *main* menu (not from the Objects window menu): `Praat > Settings > Sound recording settings...` where you may adjust certain global settings as needed. 
