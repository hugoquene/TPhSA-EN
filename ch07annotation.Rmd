...
*Chapter keywords*: phonetics, linguistic units, sounds, coarticulation, annotating, annotation, segment, segments, segmenting, label, labels, labeling, transcribing, transcription, symbol, TextGrid, TextGridEditor. 
...
The TexGridEditor is very similar to the SoundEditor window which we encountered earlier (see §\@ref(sec:praatsoundeditor) and REF for details about the SoundEditor, which are also applicable to the TextGridEditor). 
