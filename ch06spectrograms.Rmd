...
**Dipthongs** (such as the vowels in the Dutch words *bij*, *bui*, *bouw*, and in the English words *mouth*, *choice*, *price*, *face*, cf. \@ref(app-lexicalsets) are composed of two different vowel sounds, with a gradual movement of the formants from their initial to final frequency values (for an example, see Fig.\@ref(fig:window-soundeditor-3) below). 
