...
- Next, in the `Praat` object window, choose `View & Edit`. This will open a so-called SoundEditor window, with the oscillogram as its main feature. For more information about the SoundEditor, see Appendix \@ref(app:praat).
