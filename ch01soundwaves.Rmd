...
abline(h=0, lty=2)
abline(v=0, lty=2)
abline(v=0.00035, lty=2)
arrows( x0=0.0045, y0=min(yy), y1=max(yy), 
        lwd=3, angle=15, col="darkred", code=3 )
text( x=0.0045, y=.2, pos=2, cex=1.25, adj=0.75, labels="Amplitude",
      col="darkred", srt=90 )
arrows( x0=0.0054, y0=-0, x1=.0054+T-0.0001,
        lwd=3, angle=15, col="darkred", code=3 )
# half a period, centered, nudge left
text( x=.0054+T/2-0.0002, y=0, pos=1, labels="Period", cex=1.25, 
      col="darkred", adj=0.5 )
arrows( x0=0, y0=0.7, x1=.00035,
