...
Frequency can only be measured, and pitch is only heard, if the sound has a periodic, repetitive pattern, as in vowels (Figure X). A non-periodic sound, such as the /s/ in the initial part of Figure X, has no periodicity (no repetitions), and hence it has no frequency and no pitch.   
