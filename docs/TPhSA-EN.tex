...
\author{true}
\date{Document compiled 14 Jan 2025 19:34}
...
For further background on \emph{formants}, see \citep{Aalto_Malinen_Vainio_2018}.
...
\item
  if the \emph{wavelength} (\(4\times \lambda\)) of the reported formant frequency matches one of the dimensions of the recording room.
\end{itemize}
