...
\date{Document compiled 16 Nov 2024 22:28}
...
\section{Frequency}\label{sec:frequency}
...
\section{Amplitude}\label{sec:amplitude}
...
\section{Wavelength}\label{sec:wavelength}
