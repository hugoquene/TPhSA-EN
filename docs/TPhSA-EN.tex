...
\date{Document compiled 02 Dec 2024 16:48}
...
\emph{Chapter keywords}: sinewave sound, complex sound, spectrum, FFT, fourier analysis, harmonics, fundamental, overtone, component, timbre,
...
\subsection{Octave}\label{sec:octave}
...
\subsection{ADSR envelope}\label{adsr-envelope}
...
\section{Time envelope}\label{time-envelope}
