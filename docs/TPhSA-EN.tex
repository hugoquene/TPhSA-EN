...
\date{Document compiled 16 Dec 2024 17:41}
...
\begin{itemize}
\item
  In Fig.\ref{fig:speech-spectralslice} the 10th harmonic is at 2195 Hz, which suggests that \(f_0 \approx 219\) Hz (see §\ref{sec:FTintro}).
\item
