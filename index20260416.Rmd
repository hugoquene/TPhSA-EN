...
Quené, H. (2026). *Tutorial on Phonetics and Speech Analysis*. Retrieved 16 April 2026 from <https://hugoquene.github.io/TPhSA-EN> .
...
This work is based on an earlier tutorial (2006) titled <cite>Tutorial for self study: basics of phonetics and how to use Praat</cite> by Clizia Welker and Hugo Quené. In turn, that 2006 tutorial was partly based on older texts by Hugo Quené, Denise Bruin and Mirjam Wester (1996-2001); these older texts acknowledged valuable comments and suggestions by Paul Boersma, Olga van Herwijnen, Kim Koppen, Eva Sittig, Joyce Vliegen and Mieke van Wijck. 

The 2006 version of the tutorial was subsequently revised and adapted to the current version using `R Markdown` [@rmarkdown2018] and `bookdown`  [@R-bookdown] in [Rstudio](https://www.rstudio.com) by Hugo Quené in 2024-2026.  
