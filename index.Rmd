...
The 2007 version of the tutorial was subsequently revised and adapted to the current version using `R Markdown` [@rmarkdown2018] and `bookdown` [@R-bookdown] in [Rstudio](https://www.rstudio.com) by Hugo Quené in 2024--2025.  
...
As indicated in the *History* subsection above, this text has been built upon older works, which in turn have benefited from text portions and from a wealth of earlier comments and suggestions by many. 
