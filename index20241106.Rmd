...
It is divided into 5 modules: basics of acoustics 1 and 2, spectrograms, LPC and PSOLA, which are, in turn, split up into different paragraphs (see index below). Every module is made of theoretical parts and of exercises (with answers in separate documents). 
...
This work is based on an earlier tutorial (2006) titled <cite>Tutorial for self study: basics of phonetics and how to use Praat</cite> by Hugo Quené and Clizia Welker. In turn, that 2006 tutorial was partly based on older texts by Hugo Quené, Denise Bruin and Mirjam Wester (1996-2000); these older texts acknowledged valuable comments and suggestions by Paul Boersma, Olga van Herwijnen, Kim Koppen, Eva Sittig, Joyce Vliegen and Mieke van Wijck. 
