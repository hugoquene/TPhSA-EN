...
```{r twotube, echo=FALSE, fig.cap="Two-tube configuration, with two coupled resonators. After Stevens (1998), Figure 3.13, and Johnson (2012), Figure 6.1.", fig.align="center"}
...
The safest method for measuring formants is to *bypass* the spectrum, and measure formants directly from a Sound object (this is further explained in Ch.\@ref(ch-LPC)). 
...
^[Also the `Help` information in the `Praat` menu, in particular its last paragraph.]. 
